...
namespace FilmsApi.Controllers
{
    [ApiController]
    [Route("api/counts")]
    public class CountsController : CustomBaseController
    {
        ...
        public async Task<ActionResult> AsignarRol(EditRoleDTO editarRolDTO)
        {
            ...
            await _userManager.AddClaimAsync(user, new Claim(ClaimTypes.Role, editarRolDTO.NameRole));
            return NoContent();
        }
        ...
        public async Task<ActionResult> RemoverRol(EditRoleDTO editarRolDTO)
        {
            ...
            await _userManager.RemoveClaimAsync(user, new Claim(ClaimTypes.Role, editarRolDTO.NameRole));
            return NoContent();
        }
